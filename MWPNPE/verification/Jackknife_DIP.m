...
sum_TT_score=zeros(800,size(DIP_score_T,2)-2);
for i=3:size(DIP_score_T,2)
    B11=sortrows(DIP_score_T,i,'descend');
    for j=1:800
...
% hold on;
% plot(vp,vp_ess(:,14),'y','Linewidth', 1.2);
% hold on;
% plot(vp,vp_ess(:,15),'r','Linewidth', 2);
% hold on;
% legend('IC','PEC','LAC','CoEWC','POEM','ION','MWPNPE','Location','NorthWest'); 
